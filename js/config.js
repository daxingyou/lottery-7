...
function _defineProperty(e, m, n) {
...
var _ssc, _ky, LotteryClass = LotteryClass || {},
...
LotteryClass = {
    ...
    LotteryTips = {
        ssc: (_ssc = {
            ...
            _defineProperty(_ssc, "qw_lhh_wq", {
                title: "万位大于千位为龙；千位大于万位为虎；万位等于千位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的万位、千位数字比较大小，万位大于千位为龙；千位大于万位为虎；万位等于千位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_wb", {
                title: "万位大于百位为龙；百位大于万位为虎；万位等于百位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的万位、百位数字比较大小，万位大于百位为龙；百位大于万位为虎；万位等于百位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_ws", {
                title: "万位大于十位为龙；十位大于万位为虎；万位等于十位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的万位、十位数字比较大小，万位大于十位为龙；十位大于万位为虎；万位等于十位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_wg", {
                title: "万位大于个位为龙；个位大于万位为虎；万位等于个位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的万位、个位数字比较大小，万位大于个位为龙；个位大于万位为虎；万位等于个位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_qb", {
                title: "千位大于百位为龙；百位大于千位为虎；千位等于百位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的千位、百位数字比较大小，千位大于百位为龙；百位大于千位为虎；千位等于百位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_qs", {
                title: "千位大于十位为龙；十位大于千位为虎；千位等于十位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的千位、十位数字比较大小，千位大于十位为龙；十位大于千位为虎；千位等于十位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_qg", {
                title: "千位大于个位为龙；个位大于千位为虎；千位等于个位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的千位、个位数字比较大小，千位大于个位为龙；个位大于千位为虎；千位等于个位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_bs", {
                title: "百位大于十位为龙；十位大于百位为虎；百位等于十位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的百位、十位数字比较大小，百位大于十位为龙；十位大于百位为虎；百位等于十位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_bg", {
                title: "百位大于个位为龙；个位大于百位为虎；百位等于个位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的百位、个位数字比较大小，百位大于个位为龙；个位大于百位为虎；百位等于个位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_lhh_sg", {
                title: "十位大于个位为龙；个位大于十位为虎；十位等于个位为和。",
                paraphrase: "在龙、虎、和三种形态中选择一种。用开奖号码的十位、个位数字比较大小，十位大于个位为龙；个位大于十位为虎；十位等于个位为和。开奖结果与投注项相符，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_ts_yffs", {
                title: "从0-9中至少选择一个号码，每个号码作为一注。若开奖号码中包含所选号码，即为中奖。",
                paraphrase: "从0-9中至少选择一个号码，每个号码作为一注。若开奖号码中包含所选号码，即为中奖。"
            }),
            _defineProperty(_ssc, "qw_ts_hscs", {
                title: "从0-9中至少选择一个号码，每个号码作为一注。若所选号码在开奖号码中出现2次（或以上），即为中奖。",
                paraphrase: "从0-9中至少选择一个号码，每个号码作为一注。若所选号码在开奖号码中出现2次（或以上），即为中奖。"
            }),
            _defineProperty(_ssc, "qw_ts_sxbx", {
                title: "从0-9中至少选择一个号码，每个号码作为一注。若所选号码在开奖号码中出现3次（或以上），即为中奖。",
                paraphrase: "从0-9中至少选择一个号码，每个号码作为一注。若所选号码在开奖号码中出现3次（或以上），即为中奖。"
            }),
            _defineProperty(_ssc, "qw_ts_sjfc", {
                title: "从0-9中至少选择一个号码，每个号码作为一注。若所选号码在开奖号码中出现4次（或以上），即为中奖。",
                paraphrase: "从0-9中至少选择一个号码，每个号码作为一注。若所选号码在开奖号码中出现4次（或以上），即为中奖。"
            }),
            _defineProperty(_ssc, "qw_xt_q3", {
            ...
            _defineProperty(_ssc, "qw_bjl_bjl", {
        ...
        "11y": {
            ...
            rxdt_rxdt_2z2: {
                title: "分别从胆码和拖码的01-11中，选择1个胆码和至少2个拖码。",
                paraphrase: "只要当期顺序摇出的5个开奖号码中，包含所选的胆码和拖码组成的注单，即为中奖。"
            },
            rxdt_rxdt_3z3: {
                title: "分别从胆码和拖码的01-11中，选择1-2个胆码和至少2个拖码。",
                paraphrase: "只要当期顺序摇出的5个开奖号码中，包含所选的胆码和拖码组成的注单，即为中奖。"
            },
            rxdt_rxdt_4z4: {
                title: "分别从胆码和拖码的01-11中，选择1-3个胆码和至少2个拖码。",
                paraphrase: "只要当期顺序摇出的5个开奖号码中，包含所选的胆码和拖码组成的注单，即为中奖。"
            },
            rxdt_rxdt_5z5: {
                title: "分别从胆码和拖码的01-11中，选择1-4个胆码和至少2个拖码。",
                paraphrase: "只要当期顺序摇出的5个开奖号码，与所选的胆码和拖码组成的注单相同，即为中奖"
            },
            rxdt_rxdt_6z5: {
                title: "分别从胆码和拖码的01-11中，选择1-5个胆码和至少2个拖码。",
                paraphrase: "只要当期顺序摇出的5个开奖号码，出现在所选的胆码和拖码组成的注单中，即为中奖。"
            },
            rxdt_rxdt_7z5: {
                title: "分别从胆码和拖码的01-11中，选择1-6个胆码和至少2个拖码。",
                paraphrase: "只要当期顺序摇出的5个开奖号码，出现在所选的胆码和拖码组成的注单中，即为中奖。"
            },
            rxdt_rxdt_8z5: {
                title: "分别从胆码和拖码的01-11中，选择1-7个胆码和至少2个拖码。",
                paraphrase: "只要当期顺序摇出的5个开奖号码，出现在所选的胆码和拖码组成的注单中，即为中奖。"
            }
        },
        pk10: {
        ...
        "3d": {
            ...
            qw_lhh_sg: {
                title: "十位大于个位为龙；个位大于十位为虎；十位等于个位为和。",
                paraphrase: "在龙、虎xt、和三种形态中选择一种。用开奖号码的十位、个位数字比较大小，十位大于个位为龙；个位大于十位为虎；十位等于个位为和。开奖结果与投注项相符，即为中奖。"
            },
            qw_xt_xt: {
                title: "下注百位、十位、个位三个位置上的开奖号码所组成的形态（顺序不限），每个形态为一注。",
                paraphrase: "下注百位、十位、个位三个位置上的开奖号码所组成的形态（顺序不限），每个形态为一注。所选形态与开奖号码相符，即为中奖。豹子：三个数字相同，如：111, 222；顺子：三个数字各不相同且相连，如：123, 234, 890, 901, 012.（9与0相连，0与1相连）；对子：三个数字中有1个数字出现了两次，另1个数字出现一次，例如：113, 252, 899；半顺：三个数字各不相同，且其中有2个数字相连，另一个数字不相连,例如：125, 569, 108；杂六：三个数字各不相同，且各不相连，例如：247, 369, 538。"
    ...
    localStorage.setItem("LotteryClass", JSON.stringify(LotteryClass)),
    localStorage.setItem("LotteryTips", JSON.stringify(LotteryTips));